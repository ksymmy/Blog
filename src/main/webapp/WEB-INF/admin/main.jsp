...
<div region="north" style="height: 78px;background-color: #E0ECFF">
	<table style="padding: 5px" width="100%">
		<tr>
			<td width="50%">
				<img alt="logo" src="${pageContext.request.contextPath}/static/images/logo.png" style="max-height: 60px;">
			</td>
                ...
                <c:when test="${!state.last}">
                    <div title="${big.text}" data-options="iconCls:'${big.iconCls}'" style="padding: 10px;">
                        <c:forEach items="${big.children}" var="small">
                            <a name="c" href="javascript:openTab('${small.text}','${small.url}','${small.iconCls}')" class="easyui-linkbutton" data-options="plain:true,iconCls:'${small.iconCls}'" style="width: 150px;">${small.text}</a>
                        </c:forEach>
                    </div>
                </c:when>
                <c:otherwise>
                    <div title="${big.text}" data-options="iconCls:'${big.iconCls}'" style="padding: 10px;">
                        ...
                        <a name="c" href="javascript:openPasswordModifyDialog()" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-modifyPassword'" style="width: 150px;">修改密码</a>
                        <a name="c" href="javascript:refreshSystem()" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-refresh'" style="width: 150px;">刷新系统缓存</a>
                        <a name="c" href="javascript:logout()" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-exit'" style="width: 150px;">安全退出</a>
                    </div>
                </c:otherwise>
            </c:choose>
		</c:forEach>
...
<div id="tab-tools">
	<a href="javascript:void(0);"  class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-help'" onclick=""></a>
</div>
