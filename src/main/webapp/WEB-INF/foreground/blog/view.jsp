...
<div class="data_list">
	...
	<div>
	   ...
	   <div style="padding-left: 330px;padding-bottom: 20px;padding-top: 10px">
		...
		<div class="blog_info">
			发布时间：『 <fmt:formatDate value="${blog.releaseDate}" type="date" pattern="yyyy-MM-dd HH:mm:ss"/>』&nbsp;&nbsp;博客类别：${blog.blogType.typeName}&nbsp;&nbsp;阅读(${blog.clickHit}) 评论(${blog.replyHit})
		</div>
				...
				<c:forEach var="comment" items="${commentList}" varStatus="status">
						<c:choose>
							<c:when test="${status.index<10 }">
								<div class="comment">
                                    <span><font>${status.index+1 }楼&nbsp;&nbsp;&nbsp;&nbsp;${comment.userIp }：</font>${comment.content}</span><span style="float: right;">[<fmt:formatDate value="${comment.commentDate }" type="date" pattern="yyyy-MM-dd HH:mm:ss"/>]</span>
								</div>
							</c:when>
							<c:otherwise>
...
<div class="data_list">
	...
	<div class="publish_comment">
			...
			<div class="verCode">
				验证码：<input type="text" value="${imageCode}" name="imageCode"  id="imageCode" size="10"/>&nbsp;<img onclick="javascript:loadimage();" title="换一张试试" name="randImage" id="randImage" src="${pageContext.request.contextPath}/image.jsp" width="60" height="20" border="1" align="absmiddle">
			</div>
...
<%--
<p>评论数:<a href="#SOHUCS" id="changyan_count_unit"></a> &nbsp;&nbsp; 参与数:<a href="#SOHUCS" id="changyan_parti_unit"></a></p>
...
<script type="text/javascript">
    window.changyan.api.config({
        appid: 'cytoNX0iF',
        conf: 'prod_ce5637fbcfe24b60b591f82a0d6786a0'
    });
</script>--%>
